...
INSERT INTO `admins` (`id`, `username`, `password_hash`, `first_name`, `last_name`, `role`, `is_active`) VALUES
	(1, 'admin', 'pbkdf2_sha256$1200000$cNziIieprVVvRgj2dEsiiw$zooe389nLDugcVfQb1eYyuEPZPHC7sghK5Ip2LDzNd0=', 'เจ้าของ', 'หอพัก', 'owner', 1),
...
INSERT INTO `django_session` (`session_key`, `session_data`, `expire_date`) VALUES
	('q0b8macgdzvdhusexq782kx53igfb4uv', '.eJyrVkpMyc3Mi89MUbIy1IFyivJzUpWslPLL81KLlGCCeYm5IMGYUoNUEwMQaWABZluCSGMjsAiYNEoBs80VwJwkhJBhKlipIVjaUKkWANriJ3E:1w6tqv:88DPy0p4_G5wqcaWvO1471Axjf4fc7wSroj9w7C3Uqg', '2026-04-12 17:23:09.289963');
...
-- Dumping data for table arm_live.rooms: ~4 rows (approximately)
...
INSERT INTO `system_info` (`id`, `short_name`, `full_name`, `description`, `address`, `phone`, `email`, `tax_id`, `water_rate`, `electricity_rate`, `promptpay_no`, `promptpay_name`, `system_version`, `updated_at`) VALUES
	(1, 'ARM', 'Apartment Room Management', 'ระบบจัดการห้องพัก', 'โชคกมล อพาร์ทเม้นท์ 73 ซอย จิ๊ปดำริห์ รัชดาภิเษก ดินแดง กรุงเทพฯ 10400', '0838625365', 'nontawat.work321@gmail.com', '0105578659843', 15.00, 7.00, '0838625365', 'นายนนทวัตร์ เหรียญเจริญ', '1.0.2', '2026-03-29 23:31:32');
...
INSERT INTO `tenants` (`id`, `first_name`, `last_name`, `phone`, `gender`, `id_card_no`, `email`, `address`, `avatar`) VALUES
	(1, 'สมชาย', 'ใจดี', '0812345678', 'male', '1101234567890', 'somchai@email.com', '123 ม.1 ต.บางรัก อ.เมือง จ.กรุงเทพฯ', NULL),
	(2, 'สมศรี', 'มีทรัพย์', '0898765432', 'female', '2209876543210', 'somsri@email.com', '456 ม.2 ต.ช้างเผือก อ.เมือง จ.เชียงใหม่', NULL),
	(4, 'นนทวัตร์', 'เหรียญเจริญ', '0838625365', 'male', '1249900687821', 'nontawat.work321@gmail.com', '123 ม.1 ต.บางรัก อ.เมือง จ.กรุงเทพฯ', NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='ตารางเก็บข้อมูลยานพาหนะของผู้เช่า';
...
INSERT INTO `vehicles` (`id`, `tenant_id`, `license_plate`, `province`, `brand`, `color`, `vehicle_type`, `note`, `registered_at`) VALUES
	...
	(3, 2, 'ขค 9999', 'นนทบุรี', 'Toyota Yaris', 'เทา', 'car', NULL, '2026-03-30 00:11:25');

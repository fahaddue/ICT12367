...
INSERT INTO `admins` (`id`, `username`, `password_hash`, `first_name`, `last_name`, `role`, `is_active`) VALUES
	...
	(2, 'staff01', 'pbkdf2_sha256$1200000$cNziIieprVVvRgj2dEsiiw$zooe389nLDugcVfQb1eYyuEPZPHC7sghK5Ip2LDzNd0=', 'พนักงาน', 'ต้อนรับ', 'staff', 1);
...
INSERT INTO `contracts` (`id`, `tenant_id`, `room_id`, `start_date`, `end_date`, `deposit`, `is_active`, `is_signed`, `signature_data`, `signature_type`, `signed_at`, `made_at`, `advance_payment_months`, `rent_due_day`, `witness_1`, `witness_2`) VALUES
	(1, 1, 1, '2023-01-01', '2023-12-31', 3500.00, 1, 0, NULL, NULL, NULL, NULL, 1, 5, NULL, NULL),
	(2, 2, 3, '2023-05-01', '2024-04-30', 4500.00, 1, 0, NULL, NULL, NULL, NULL, 1, 5, NULL, NULL);
...
INSERT INTO `django_session` (`session_key`, `session_data`, `expire_date`) VALUES
	('q0b8macgdzvdhusexq782kx53igfb4uv', '.eJyrVkpMyc3Mi89MUbIy1IFyivJzUpWslPLL81KLlGCCeYm5IMGYUoNUEwMQaWABZluCSGMjsAiYNEoBs80VwJwkhJBhKlipIVjaUKkWANriJ3E:1wDGyp:UR6vZ8M38eAfJdqj0dfY3mlYcju2o-zZuPXG3LEhkSc', '2026-04-30 07:17:39.423545');
...
-- Dumping data for table arm_live.invoices: ~4 rows (approximately)
INSERT INTO `invoices` (`id`, `contract_id`, `invoice_date`, `due_date`, `room_charge`, `water_charge`, `electricity_charge`, `other_charge`, `total_amount`, `is_paid`) VALUES
	...
	(2, 2, '2023-10-25', '2023-11-05', 4500.00, 10.00, 10.00, 0.00, 4520.00, 1),
	(3, 1, '2026-04-14', '2026-05-02', 3500.00, 40.00, 1000.00, 0.00, 4540.00, 0),
	(4, 2, '2026-04-14', '2026-05-02', 4500.00, 10.00, 10.00, 0.00, 4520.00, 0);
...
-- Dumping data for table arm_live.maintenance_requests: ~3 rows (approximately)
INSERT INTO `maintenance_requests` (`id`, `room_id`, `tenant_id`, `description`, `status`, `created_at`, `repair_cost`, `admin_remark`) VALUES
	(1, 3, 2, 'แอร์ไม่เย็น มีน้ำหยด', 'in_progress', '2023-10-15 09:00:00', 100.00, 'ทดสอบเพิ่มข้อมูล'),
	(2, 4, NULL, 'หลอดไฟในห้องน้ำขาด (ห้องว่าง)', 'pending', '2023-10-20 14:00:00', 0.00, NULL),
	(3, 1, 1, '[แอร์] ทดสอบการซ่อม', 'pending', '2026-04-15 16:05:07', 0.00, NULL);
...
-- Dumping data for table arm_live.payments: ~6 rows (approximately)
INSERT INTO `payments` (`id`, `invoice_id`, `payment_date`, `amount`, `payment_method`, `slip_image_url`, `status`, `note`) VALUES
	(1, 1, '2025-03-30 15:45:00', 4500.00, 'bank_transfer', '', 'verified', NULL),
	(2, 2, '2025-03-30 15:45:00', 5820.00, 'bank_transfer', '', 'pending', NULL),
	(3, 3, '2026-04-15 16:26:18', 3520.00, 'bank_transfer', '', 'pending', NULL),
	(4, 3, '2026-04-15 17:06:40', 3520.00, 'bank_transfer', '', 'verified', NULL),
	(5, 3, '2026-04-15 17:29:08', 3520.00, 'bank_transfer', 'img_slip/April2026/001.png', 'wait', NULL),
	(6, 3, '2026-04-15 17:48:47', 3520.00, 'bank_transfer', 'img_slip/April2026/dino1.jpg', 'rejected', NULL),
	(7, 3, '2026-04-15 18:05:57', 3520.00, 'bank_transfer', 'img_slip/April2026/your-name-couple-3840x2160-25439.jpg', 'rejected', NULL),
	(8, 3, '2026-04-16 06:56:02', 3520.00, 'bank_transfer', 'img_slip/April2026/your-name-couple-3840x2160-25439_NYMm1Mx.jpg', 'pending', NULL);
...
-- Dumping data for table arm_live.rooms: ~7 rows (approximately)
INSERT INTO `rooms` (`id`, `room_number`, `floor`, `room_type_id`, `status`) VALUES
	...
	(5, '103', 1, 3, 'available'),
	(6, '104', 1, 3, 'maintenance'),
	(7, '301', 3, 3, 'maintenance');
...
-- Dumping data for table arm_live.room_types: ~3 rows (approximately)
...
INSERT INTO `system_info` (`id`, `short_name`, `full_name`, `description`, `address`, `phone`, `email`, `tax_id`, `water_rate`, `electricity_rate`, `promptpay_no`, `promptpay_name`, `system_version`, `updated_at`) VALUES
	(1, 'ARM', 'Apartment Room Management', 'ระบบจัดการห้องพัก', 'โชคกมล อพาร์ทเม้นท์ 73 ซอย จิ๊ปดำริห์ รัชดาภิเษก ดินแดง กรุงเทพฯ 10400', '0838625365', 'nontawat.work321@gmail.com', '0105578659843', 20.00, 10.00, '0838625365', 'นายนนทวัตร์ เหรียญเจริญ', '1.0.2', '2026-04-14 17:09:05');
...
-- Dumping data for table arm_live.tenants: ~3 rows (approximately)
INSERT INTO `tenants` (`id`, `first_name`, `last_name`, `phone`, `gender`, `id_card_no`, `email`, `address`, `avatar`, `notify_email`, `notify_line`, `sync_calendar`, `calendar_email`) VALUES
	(1, 'สมชาย-ทดสอบแก้ไข', 'ใจดี-ทดสอบแก้ไข', '0812345678', 'male', '1101234567890', 'somchai@email.com', '123 ม.1 ต.บางรัก อ.เมือง จ.กรุงเทพฯ', NULL, 1, 0, 1, 'somchai@email.com'),
	(2, 'สมศรี', 'มีทรัพย์', '0898765432', 'female', '2209876543210', 'somsri@email.com', '456 ม.2 ต.ช้างเผือก อ.เมือง จ.เชียงใหม่', NULL, 1, 0, 0, NULL),
	(4, 'นนทวัตร์', 'เหรียญเจริญ', '0838625365', 'male', '1249900687821', 'nontawat.work321@gmail.com', '123 ม.1 ต.บางรัก อ.เมือง จ.กรุงเทพฯ', NULL, 1, 0, 0, NULL),
	(5, 'ทดสอบ', 'ทดสอบ', '123123123', 'female', '123123123123', 'test@gmail.com', 'ddd', NULL, 1, 0, 0, NULL);
...
-- Dumping data for table arm_live.vehicles: ~3 rows (approximately)
INSERT INTO `vehicles` (`id`, `tenant_id`, `license_plate`, `province`, `brand`, `color`, `vehicle_type`, `note`, `registered_at`) VALUES
	(1, 1, 'กค 1234', 'กรุงเทพมหานคร', 'Honda City', 'ขาว', 'car', 'จอดประจำช่อง A1', '2026-03-30 00:11:25'),
	(2, 1, '1กข 5678', 'เชียงใหม่', 'Yamaha Fino', 'ดำ-แดง', 'motorcycle', 'จอดโซนมอเตอร์ไซค์', '2026-03-30 00:11:25'),
	(4, 1, 'ทดสอบ123', 'กรุงเทพ', 'Honda', 'ขาว', 'car', 'ทดสอบ', '2026-04-14 13:18:45');
